...
{
	$cn=makeconnection();
	$s="update users set pwd='" . $_POST["t2"] ."',Typeofuser='" . $_POST["s1"] . "', Username='" .$_POST["t4"] ."' where Username='" . $_POST["t1"] . "'";
	mysqli_query($cn,$s);
	mysqli_close($cn);
...
<tr><td class="lefttxt">Username</td><td><input type="text"  value="<?php if(isset($_POST["show"])){ echo $Username ;} ?>" name="t4" required pattern="[a-zA-z]{5,10}" title=" Please Enter Only Characters and Usrname must greater than 5 and less than 10 character long Only"/></td></tr>
