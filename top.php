			 ...
			 <div class="top-nav">
						...
						<ul id="nav">
							 <li><a href="index.php#section-1"  onclick="javascript:window.open('index.php#section-1','_self')">                            Home</a></li>
							  <li><a href="category.php" onclick="javascript:window.open('category.php','_self')">Tour Package</a></li>
							 ...
							 <li><a href="contact.php"  onclick="javascript:window.open('contact.php','_self')">Contact</a></li>
